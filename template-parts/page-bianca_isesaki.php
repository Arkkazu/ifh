   ...
   <section class="c-sec">
     <div class="c-width --sub">
       ...
       <div class="c-salon-swiper swiper">
         ...
         <div class="swiper-wrapper">
           ...
           <div class="c-salon-swiper__slide swiper-slide">
             <img class="c-salon-swiper__img" src="/wp-content/themes/ifh_theme/assets/media/images/hair/bi-slide-01.webp" alt="BIANCA伊勢崎" width="756" height="506">
           </div>
           <div class="c-salon-swiper__slide swiper-slide">
             <img class="c-salon-swiper__img" src="/wp-content/themes/ifh_theme/assets/media/images/hair/bi-slide-02.webp" alt="BIANCA伊勢崎" width="756" height="506">
           </div>
           <div class="c-salon-swiper__slide swiper-slide">
             <img class="c-salon-swiper__img" src="/wp-content/themes/ifh_theme/assets/media/images/hair/bi-slide-03.webp" alt="BIANCA伊勢崎" width="756" height="506">
           </div>
           <div class="c-salon-swiper__slide swiper-slide">
             <img class="c-salon-swiper__img" src="/wp-content/themes/ifh_theme/assets/media/images/hair/bi-slide-04.webp" alt="BIANCA伊勢崎" width="756" height="506">
           </div>
           <div class="c-salon-swiper__slide swiper-slide">
             <img class="c-salon-swiper__img" src="/wp-content/themes/ifh_theme/assets/media/images/hair/bi-slide-05.webp" alt="BIANCA伊勢崎" width="756" height="506">
           </div>
         </div>
       </div>

       <div class="underbar-ttl-wrap u-mt150">
         <h1 class="underbar-ttl u-block-center">BIANCA isesaki</h1>
       ...
       <div class="c-salon-cat u-mt80">
         ...
         <div class="bg-black w-60 pc:w-90 h-20 pc:h-24 flex justify-center items-center text-white font-josefin font-light">Self-esthe</div>
       </div>

       <p class="c-txt u-txt-center u-mt80">
         BIANCA isesakiは皆様に居心地のいい空間をご提供するため
         <span class="u-ib">外観、内観全てにこだわったトータルビューティーサロンです。</span>
         <span class="u-ib">シャンプーの香りも11種類の中からその日の気分に合わせてお選びいただけます。</span>
         <span class="u-ib">そして自信を持って骨格に合わせた似合わせカット、</span>
         <span class="u-ib">再現性のある技術を得意としています。</span>
       </p>

       <dl class="c-salon-info u-mt150">
         <dt class="c-salon-info__term">住　　所</dt>
         <dd class="c-salon-info__desc">〒372-0007　群馬県伊勢崎市安堀町207-1</dd>
         <dt class="c-salon-info__term">電　　話</dt>
         <dd class="c-salon-info__desc">0270-27-4572</dd>
       ...
       <div class="c-salon-link-btn-cntr u-mt150">
         <a href="https://maps.app.goo.gl/trWUatmWPSAWhoNR9" target='_blank' class="c-salon-link-btn">MAP</a>
         <a href="https://beauty.hotpepper.jp/slnH000491807/" target='_blank' class="c-salon-link-btn">WEB 予約／クーポン</a>
