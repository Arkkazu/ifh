...
<body id="nail" class="lower">
  <div class="overflow-hidden">
    ...
    <main class="relative pt-60 pc:pt-90 pb-80 pc:pb-160">
      ...
      ?>
        ...
        <section class="mt-80 pc:mt-150">
          <div class="mx-auto max-w-560 pc:max-w-1300 px-40 pc:px-50">
            <div class="flex justify-center items-center gap-x-16">
              <div class="bg-border w-20 h-1 -translate-y-1/2 rotate-[-60deg]"></div>
              <h2 class="text-20 font-josefin font-normal leading-none">Light course design</h2>
              <div class="bg-border w-20 h-1 -translate-y-1/2 rotate-[-60deg]"></div>
            </div>

            <div class="mt-16">
              <p class="text-14 text-center">ライトコース　ネイルギャラリー</p>
            </div>
            ...
            <div class="mt-40 pc:mt-80">
              <div class="flex justify-center">
                <a class="relative w-124 h-40 block group" href="/nail_light/">
      ...
      ?>
        ...
        <section class="mt-80 pc:mt-150">
          <div class="mx-auto max-w-560 pc:max-w-1300 px-40 pc:px-50">
            <div class="flex justify-center items-center gap-x-16">
              <div class="bg-border w-20 h-1 -translate-y-1/2 rotate-[-60deg]"></div>
              <h2 class="text-20 font-josefin font-normal leading-none">Standard course design</h2>
              <div class="bg-border w-20 h-1 -translate-y-1/2 rotate-[-60deg]"></div>
            </div>

            <div class="mt-16">
              <p class="text-14 text-center">スタンダードコース　ネイルギャラリー</p>
            </div>

            <div class="mt-46 pc:mt-80">
              <div class="splide splide-nail max-w-480 pc:max-w-full mx-auto">
                <div class="splide__track">
                  <ul class="splide__list">
                    <?php
              ...
              <div id="<?php echo $modalId; ?>" class="js-modal opacity-0 invisible fixed -z-10 left-0 top-0 w-full h-full overflow-auto bg-black bg-opacity-40 transition-opacity duration-300">
                <div class="js-modal-cont-wrap absolute top-1/2 left-[calc(50%+(100vw-100%)/2)] transform -translate-x-1/2 -translate-y-1/2 max-w-[90%] pc:max-w-600 w-full pc:w-calc-30">
                  ...
                  <div class="js-modal-cont relative border border-black bg-beige py-80 pc:py-120 px-24 pc:px-80 max-h-800">
                    <div class="absolute top-16 right-16 text-40 leading-none hover:cursor-pointer js-modal-close">×</div>
                    <div class="absolute top-80">
                      <p class="text-18 leading-none font-josefin">Standard course design</p>
                    </div>
                    <div class="splide splide-modal">
                      <div class="splide__track">
                        <ul class="splide__list">
            ...
            <div class="mt-40 pc:mt-80">
              <div class="flex justify-center">
                <a class="relative w-124 h-40 block group" href="/nail_standard/">
                  <div class="absolute top-2 left-0 flex flex-col gap-y-4 duration-500 group-hover:left-5">
                    <p class="font-josefin text-14 leading-none font-normal">View More</p>
                    <div class="relative w-104 h-1 bg-border">
                      <div class="absolute top-1/2 right-0 w-12 h-1 -translate-y-1/2 rotate-45 bg-border transform origin-bottom-right"></div>
      ...
      ?>
        ...
        <section class="mt-80 pc:mt-150">
          <div class="mx-auto max-w-560 pc:max-w-1300 px-40 pc:px-50">
            <div class="flex justify-center items-center gap-x-16">
              <div class="bg-border w-20 h-1 -translate-y-1/2 rotate-[-60deg]"></div>
              <h2 class="text-20 font-josefin font-normal leading-none">Premium course design</h2>
              <div class="bg-border w-20 h-1 -translate-y-1/2 rotate-[-60deg]"></div>
            </div>

            <div class="mt-16">
              <p class="text-14 text-center">プレミアムコース　ネイルギャラリー</p>
            </div>
              ...
              <div id="<?php echo $modalId; ?>" class="js-modal opacity-0 invisible fixed -z-10 left-0 top-0 w-full h-full overflow-auto bg-black bg-opacity-40 transition-opacity duration-300">
                <div class="js-modal-cont-wrap absolute top-1/2 left-[calc(50%+(100vw-100%)/2)] transform -translate-x-1/2 -translate-y-1/2 max-w-[90%] pc:max-w-600 w-full pc:w-calc-30">
                  ...
                  <div class="js-modal-cont relative border border-black bg-beige py-80 pc:py-120 px-24 pc:px-80 max-h-800">
                    <div class="absolute top-16 right-16 text-40 leading-none hover:cursor-pointer js-modal-close">×</div>
                    <div class="absolute top-80">
                      <p class="text-18 leading-none font-josefin">Premium course design</p>
                    </div>
                    <div class="splide splide-modal">
                      <div class="splide__track">
                        <ul class="splide__list">
            ...
            <div class="mt-40 pc:mt-80">
              <div class="flex justify-center">
                <a class="relative w-124 h-40 block group" href="/nail_premium/">
                  <div class="absolute top-2 left-0 flex flex-col gap-y-4 duration-500 group-hover:left-5">
                    <p class="font-josefin text-14 leading-none font-normal">View More</p>
                    <div class="relative w-104 h-1 bg-border">
                      <div class="absolute top-1/2 right-0 w-12 h-1 -translate-y-1/2 rotate-45 bg-border transform origin-bottom-right"></div>
