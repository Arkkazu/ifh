            ...
            <div class="content_inner">
              ...
              <div class="content_section">
                <div class="img_full content_mb">
                  <img src="/wp-content/themes/ifh_theme/assets/media/images/lower/ang_nail_motosoujya.jpg" alt="" width="1240" height="825">
                </div>
                <div class="shop_area">
                  <div class="shop_name">
                    Angelique Nail motosouja <span>アンジェリーク・ネイル 元総社町店</span>
                  </div>
                  <div class="shop_cate">
                    NAIL
                  </div>
                ...
                <div class="shop_area">
                  <div class="shop_text">《Angelique Nail》が前橋元総社町にOPEN★<br>近代的な極上空間であなただけの「こだわり」を再現してみませんか？<br>技術力に自信アリのスタッフが在籍！Eyeと同時施術OK◎<br>働く女性もお子様連れも通いやすいヘアサロン併設のトータルビューティーサロンです♪<br>質とケアにこだわったメニューを多数ご用意してお待ちしております！</div>
                </div>
              </div>
