...
<body <?php body_class('relative h-full flex flex-col overflow-hidden'); ?>>
      ...
      <section class="c-sec">
        <div class="c-width --sub">
          ...
          <div class="c-salon-swiper swiper">
            ...
            <div class="swiper-wrapper">
              ...
              <div class="c-salon-swiper__slide swiper-slide">
                <img class="c-salon-swiper__img" src="/wp-content/themes/ifh_theme/assets/media/images/hair/h-slide-01.webp" alt="Ifh本店" width="756" height="506">
              </div>
              <div class="c-salon-swiper__slide swiper-slide">
                <img class="c-salon-swiper__img" src="/wp-content/themes/ifh_theme/assets/media/images/hair/h-slide-02.webp" alt="Ifh本店" width="756" height="506">
              </div>
              <div class="c-salon-swiper__slide swiper-slide">
                <img class="c-salon-swiper__img" src="/wp-content/themes/ifh_theme/assets/media/images/hair/h-slide-03.webp" alt="Ifh本店" width="756" height="506">
              </div>
              <div class="c-salon-swiper__slide swiper-slide">
                <img class="c-salon-swiper__img" src="/wp-content/themes/ifh_theme/assets/media/images/hair/h-slide-04.webp" alt="Ifh本店" width="756" height="506">
              </div>
              <div class="c-salon-swiper__slide swiper-slide">
                <img class="c-salon-swiper__img" src="/wp-content/themes/ifh_theme/assets/media/images/hair/h-slide-05.webp" alt="Ifh本店" width="756" height="506">
              </div>
            </div>
          </div>

          <div class="underbar-ttl-wrap u-mt150">
            <h1 class="underbar-ttl u-block-center">Ifh honten</h1>
          ...
          <p class="c-txt u-txt-center u-mt80">
            Ifh hontenはヘアメニューだけでなく
            <span class="u-ib">ネイルメニューやアイメニューなども</span>
            <span class="u-ib">充実しているトータルビューティーサロンです。</span>
            <span class="u-ib">アンティーク調の落ち着いたエントランスに明るい店内。</span>
            <span class="u-ib">接客・技術共にご満足頂ける空間をご提供いたします。</span>
          </p>

          <dl class="c-salon-info u-mt150">
            <dt class="c-salon-info__term">住　　所</dt>
            <dd class="c-salon-info__desc">〒370-3521　群馬県高崎市棟高町1802-306</dd>
            <dt class="c-salon-info__term">電　　話</dt>
            <dd class="c-salon-info__desc">027-381-5133</dd>
          ...
          <div class="c-salon-link-btn-cntr u-mt150">
            <a href="https://maps.app.goo.gl/kFu2X6FuUZo834Cm7" target='_blank' class="c-salon-link-btn">MAP</a>
            <a href="https://beauty.hotpepper.jp/slnH000205135/" target='_blank' class="c-salon-link-btn">WEB 予約／クーポン</a>
  ...
  <script>
    const salonSwiper = new Swiper(".c-salon-swiper", {
      loop: true,
